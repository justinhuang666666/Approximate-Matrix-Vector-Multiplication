...
# Replace with quantized model
quant_svd_model = replace_with_quantized_svd(model, 300, quant_scheme_int, filter)
...
# Replace with quantized model
quant_svd_model = replace_with_quantized_svd(model, 100, quant_scheme_int, filter)
