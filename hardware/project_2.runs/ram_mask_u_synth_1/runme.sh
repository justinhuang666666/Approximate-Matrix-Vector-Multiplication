...
HD_PWD='D:/project_2/project_2.runs/ram_mask_u_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_mask_u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_mask_u.tcl
