...
HD_PWD='D:/project_2/project_2.runs/blk_mem_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_1.tcl
