...
HD_PWD='D:/project_2/project_2.runs/mask_u_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mask_u_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mask_u_1.tcl
