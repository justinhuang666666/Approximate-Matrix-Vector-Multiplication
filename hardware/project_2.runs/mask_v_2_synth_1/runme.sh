...
HD_PWD='D:/project_2/project_2.runs/mask_v_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mask_v_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mask_v_2.tcl
