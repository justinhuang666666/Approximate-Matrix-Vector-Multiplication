...
HD_PWD='D:/project_2/project_2.runs/ram_mask_v_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_mask_v.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_mask_v.tcl
