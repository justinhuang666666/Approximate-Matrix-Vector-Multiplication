...
HD_PWD='D:/project_2/project_2.runs/db_v_tile_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log db_v_tile_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source db_v_tile_ram.tcl
