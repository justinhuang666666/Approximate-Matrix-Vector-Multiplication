...
HD_PWD='D:/project_2/project_2.runs/fix_mult_16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fix_mult_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fix_mult_16.tcl
