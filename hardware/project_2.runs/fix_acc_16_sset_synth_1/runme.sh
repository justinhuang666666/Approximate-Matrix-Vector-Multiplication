...
HD_PWD='D:/project_2/project_2.runs/fix_acc_16_sset_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fix_acc_16_sset.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fix_acc_16_sset.tcl
