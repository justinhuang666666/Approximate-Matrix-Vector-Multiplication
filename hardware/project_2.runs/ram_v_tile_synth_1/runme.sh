...
HD_PWD='D:/project_2/project_2.runs/ram_v_tile_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_v_tile.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_v_tile.tcl
