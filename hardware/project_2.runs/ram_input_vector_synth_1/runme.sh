...
HD_PWD='D:/project_2/project_2.runs/ram_input_vector_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_input_vector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_input_vector.tcl
