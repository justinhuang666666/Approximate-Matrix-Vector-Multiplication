...
#
# Generated by export_simulation on Tue May 21 21:06:37 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './s_pruned_1.sh' script.

./s_pruned_1.sh -reset_run
...
./s_pruned_1.sh -noclean_files

For more information on the script, please type './s_pruned_1.sh -help'.
