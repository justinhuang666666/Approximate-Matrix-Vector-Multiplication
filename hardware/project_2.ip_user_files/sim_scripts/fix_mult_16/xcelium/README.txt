...
#
# Generated by export_simulation on Sat May 18 13:16:59 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './fix_mult_16.sh' script.

./fix_mult_16.sh -reset_run
...
./fix_mult_16.sh -noclean_files

For more information on the script, please type './fix_mult_16.sh -help'.
