...
#
# Generated by export_simulation on Tue May 21 21:07:30 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './s_pruned_2.sh' script.

./s_pruned_2.sh -reset_run
...
./s_pruned_2.sh -noclean_files

For more information on the script, please type './s_pruned_2.sh -help'.
