...
#
# Generated by export_simulation on Tue Jun 04 14:44:12 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './ram_test.sh' script.

./ram_test.sh -reset_run
...
./ram_test.sh -noclean_files

For more information on the script, please type './ram_test.sh -help'.
