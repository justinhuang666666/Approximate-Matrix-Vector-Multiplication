...
#
# Generated by export_simulation on Thu May 30 22:23:57 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './blk_mem_1.sh' script.

./blk_mem_1.sh -reset_run
...
./blk_mem_1.sh -noclean_files

For more information on the script, please type './blk_mem_1.sh -help'.
