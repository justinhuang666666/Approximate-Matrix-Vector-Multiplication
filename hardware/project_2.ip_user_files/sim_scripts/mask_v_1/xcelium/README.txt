...
#
# Generated by export_simulation on Tue May 21 21:18:01 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './mask_v_1.sh' script.

./mask_v_1.sh -reset_run
...
./mask_v_1.sh -noclean_files

For more information on the script, please type './mask_v_1.sh -help'.
