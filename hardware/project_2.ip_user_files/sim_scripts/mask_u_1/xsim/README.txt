...
#
# Generated by export_simulation on Tue May 21 21:16:08 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './mask_u_1.sh' script.

./mask_u_1.sh -reset_run
...
./mask_u_1.sh -noclean_files

For more information on the script, please type './mask_u_1.sh -help'.
