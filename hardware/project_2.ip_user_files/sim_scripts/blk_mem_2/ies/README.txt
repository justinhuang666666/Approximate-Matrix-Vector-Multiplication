...
#
# Generated by export_simulation on Fri May 31 17:10:47 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './blk_mem_2.sh' script.

./blk_mem_2.sh -reset_run
...
./blk_mem_2.sh -noclean_files

For more information on the script, please type './blk_mem_2.sh -help'.
