...
#
# Generated by export_simulation on Mon May 06 17:01:42 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './blk_mem_3.sh' script.

./blk_mem_3.sh -reset_run
...
./blk_mem_3.sh -noclean_files

For more information on the script, please type './blk_mem_3.sh -help'.
